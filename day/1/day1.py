...
food, but they need a lot of magical energy to deliver presents on Christmas.
...
know which Elf to ask: they'd like to know how many Calories are being carried
...
'''
set counters for number of elves, calories

read each line
    update calories for current elf
    if blank line, move to next elf, update max_calorie value if changed, 
        and reset colories to zero for new elf

print out max_calorie
'''
